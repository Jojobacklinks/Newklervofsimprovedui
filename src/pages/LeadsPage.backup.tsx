...
import { Search, Plus, User, TrendingUp, TrendingDown, Users, Clock, ChevronDown, Calendar, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      >
        ...
        <select
          ...
          className="flex-1 max-w-md px-4 py-2.5 border border-[#e8e8e8] rounded-[15px] focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#051046] bg-white"
        >
        ...
        {/* Date Range Picker */}
        <div className="relative flex-1 max-w-md" ref={datePickerRef}>
          <button
            onClick={() => setIsDatePickerOpen(!isDatePickerOpen)}
            className="w-full flex items-center justify-between px-4 py-2.5 border border-[#e8e8e8] rounded-[15px] text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 hover:bg-gray-50 transition-colors"
          >
        ...
        <button
          className="ml-auto px-6 py-2.5 bg-[#9810fa] text-white rounded-[32px] hover:bg-[#8610d8] transition-colors flex items-center gap-2"
